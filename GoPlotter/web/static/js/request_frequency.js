...
(function () {
    ...
    async function loadInstallations() {
        try {
            ...
            const opts = '<option value="">— Select installation —</option>' +
    ...
    async function loadUnits() {
        ...
        try {
            ...
            if (units.length > 0) {
                ...
                selectors.forEach(id => {
                    ...
                    if (el) { el.innerHTML = opts; el.value = units[0].unit.id; }
                });
                return;
            }
        ...
        try {
            ...
            if (sessData.valid && sessData.user?.installation_id) {
                installParam = '?installation_id=' + encodeURIComponent(sessData.user.installation_id);
            }
